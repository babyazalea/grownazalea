...
* 초기에는 [angular-material](https://material.angular.io/)을 이용해 간단하게 드래그 & 드롭을 구현할 계획이었으나, angular-material이 제공하는 드래그 & 드롭 애드온의 작동 방식이 이해가 되지 않았습니다. 결국 [HTML 드래그 앤 드롭 API](https://developer.mozilla.org/ko/docs/Web/API/HTML_Drag_and_Drop_API)를 이용했습니다.
